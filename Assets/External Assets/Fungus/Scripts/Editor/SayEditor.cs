...
namespace Fungus.EditorUtils
{
    ...
    public class SayEditor : CommandEditor
    {
        ...
        protected SerializedProperty voiceOverClipAddressProp;
        ...
        public override void OnEnable()
        {
            ...
            voiceOverClipAddressProp = serializedObject.FindProperty("voiceOverClipAddress");
        ...
        public override void DrawCommandGUI() 
        {
            ...
            EditorGUILayout.PropertyField(voiceOverClipAddressProp,
                                        new GUIContent("Voice Over Clip Address", "Voice over audio to play when the text is displayed"));
